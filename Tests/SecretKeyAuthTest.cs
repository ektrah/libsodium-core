...
namespace Tests
{
  ...
  public class SecretKeyAuthTest
  {
    ...
    /// <summary>
    /// Does SecretKeyAuth.SignHmacSha256() return the expected value?
    /// </summary>
    [Test]
    public void SimpleAuthHmacSha256Test()
    {
        ...
        var actual = SecretKeyAuth.SignHmacSha256(Encoding.UTF8.GetBytes("Adam Caudill"), Encoding.UTF8.GetBytes("01234567890123456789012345678901"));
        CollectionAssert.AreEqual(expected, actual);
    }

    /// <summary>
    /// Does SecretKeyAuth.SignHmacSha512() return the expected value?
    /// </summary>
    [Test]
    public void SimpleAuthHmacSha512Test()
    {
        ...
        var actual = SecretKeyAuth.SignHmacSha512(Encoding.UTF8.GetBytes("Adam Caudill"), Encoding.UTF8.GetBytes("01234567890123456789012345678901"));
        CollectionAssert.AreEqual(expected, actual);
    }
    ...
    /// <summary>
    /// Does SecretKeyAuth.VerifyHmacSha256() return the expected value?
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Does SecretKeyAuth.VerifyHmacSha512() return the expected value?
    /// </summary>
    [Test]
