...
namespace Sodium.Tests
{
    ...
    public class SecretAeadXChaCha20Poly1305ExceptionTest
    {
        ...
        public void SecretAeadXChaCha20Poly1305EncryptWithBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => SecretAeadXChaCha20Poly1305.Encrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadXChaCha20Poly1305EncryptWithBadNonce()
        {
            ...
            Assert.Throws<NonceOutOfRangeException>(() => SecretAeadXChaCha20Poly1305.Encrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadXChaCha20Poly1305EncryptWithBadAdditionalData()
        {
            ...
            Assert.Throws<AdditionalDataOutOfRangeException>(() => SecretAeadXChaCha20Poly1305.Encrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadXChaCha20Poly1305DecryptWithBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => SecretAeadXChaCha20Poly1305.Decrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadXChaCha20Poly1305DecryptWithBadNonce()
        {
            ...
            Assert.Throws<NonceOutOfRangeException>(() => SecretAeadXChaCha20Poly1305.Decrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadXChaCha20Poly1305DecryptWithBadAdditionalData()
        {
            ...
            Assert.Throws<AdditionalDataOutOfRangeException>(() => SecretAeadXChaCha20Poly1305.Decrypt(m, nonce, key, ad));
        }
    }
}
