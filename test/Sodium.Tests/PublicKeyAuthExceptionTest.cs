...
namespace Sodium.Tests
{
    ...
    public class PublicKeyAuthExceptionTest
    {
        ...
        public void GenerateKeyPairWithBadSeed()
        {
            ...
            Assert.Throws<SeedOutOfRangeException>(() => PublicKeyAuth.GenerateKeyPair(bobSk));
        }
        ...
        public void SignAuthBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyAuth.Sign(message, bobSk));
        }
        ...
        public void VerifyAuthBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyAuth.Verify(message, bobSk));
        }
        ...
        public void VerifyAuthWrongKey()
        {
            ...
            Assert.Throws<CryptographicException>(() => PublicKeyAuth.Verify(message, bobSk));
        }
        ...
        public void SignAuthDetachedBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyAuth.SignDetached(message, bobSk));
        }
        ...
        public void VerifyAuthDetachedBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyAuth.VerifyDetached(signature, message, bobSk));
        }
        ...
        public void VerifyAuthDetachedBadSignature()
        {
            ...
            Assert.Throws<SignatureOutOfRangeException>(() => PublicKeyAuth.VerifyDetached(signature, message, key));
        }
        ...
        public void ConvertEd25519PublicKeyToCurve25519PublicKeyBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyAuth.ConvertEd25519PublicKeyToCurve25519PublicKey(keypairSeed));
        }
        ...
        public void ConvertEd25519SecretKeyToCurve25519SecretKeyBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyAuth.ConvertEd25519SecretKeyToCurve25519SecretKey(keypairSeed));
        }
