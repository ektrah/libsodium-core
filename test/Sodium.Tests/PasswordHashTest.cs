...
namespace Sodium.Tests
{
    ...
    public class PasswordHashTest
    {
        ...
        /// <summary>
        ///   Derives a 16 byte long secret key from a password and a salt.
        /// </summary>
        [Test]
        public void ArgonHashBinary16ByteTest()
        {
            ...
            var hash1 = PasswordHash.ArgonHashBinary(
                Utilities.HexToBinary(PASSWORD),
                Utilities.HexToBinary(SALT),
                PasswordHash.StrengthArgon.Interactive,
                OUTPUT_LENGTH);
            var hash2 = PasswordHash.ArgonHashBinary(
                Utilities.HexToBinary(PASSWORD),
                Utilities.HexToBinary(SALT),
                PasswordHash.StrengthArgon.Interactive,
                OUTPUT_LENGTH);
        ...
        /// </summary>
        [Test]
        public void ArgonHashBinary16Test()
        {
        ...
        /// </summary>
        [Test]
        public void ArgonHashBinary32Test()
        {
            const string PASSWORD = "gkahjfkjewrykjKJHKJHKJbhuiqyr  8923fhsjfkajwehkjg";
            const string SALT = "qa~t](84z<1t<1oz";
        ...
        /// </summary>
        [Test]
        public void ArgonHashBinary128Test()
        {
            const string PASSWORD = "gkahjfkjewrykjKJHKJHKJbhuiqyr  8923fhsjfkajwehkjg";
            const string SALT = "qa~t](84z<1t<1oz";
        ...
        /// </summary>
        [Test]
        public void ArgonHashBinary512Test()
        {
            const string PASSWORD = "gkahjfkjewrykjKJHKJHKJbhuiqyr  8923fhsjfkajwehkjg";
            const string SALT = "qa~t](84z<1t<1oz";
            ...
            try
            {
                ...
                foreach (var testObject in testObjects)
                {
                    Assert.AreEqual(testObject.OutputLength,
                        PasswordHash.ArgonHashBinary(
                            Utilities.HexToBinary(testObject.Password),
                            Utilities.HexToBinary(testObject.Salt),
                            testObject.OpsLimit,
                            testObject.MemLimit,
                            testObject.OutputLength
                        ).Length);
                }
            }
            catch (OutOfMemoryException e)
        ...
        {
            const string PASSWORD = "4a857e2ee8aa9b6056f2424e84d24a72473378906ee04a46cb05311502d5250b82ad86b83c8f20a23dbb74f6da60b0b6ecffd67134d45946ac8ebfb3064294bc097d43ced68642bfb8bbbdd0f50b30118f5e";
        ...
        public void ScryptHashBinary32ByteTest()
        {
            ...
            const long OUTPUT_LENGTH = 32;
            var hash1 = PasswordHash.ScryptHashBinary(
                Utilities.HexToBinary(PASSWORD),
                Utilities.HexToBinary(SALT),
                PasswordHash.Strength.Interactive,
                OUTPUT_LENGTH);
            var hash2 = PasswordHash.ScryptHashBinary(
                Utilities.HexToBinary(PASSWORD),
                Utilities.HexToBinary(SALT),
                PasswordHash.Strength.Interactive,
                OUTPUT_LENGTH);
