...
namespace Sodium.Tests
{
    ...
    public class SecretKeyAuthTest
    {
        ...
        public void SimpleAuthHmacSha256Test()
        {
            ...
            var actual = SecretKeyAuth.SignHmacSha256(
                Encoding.UTF8.GetBytes("Adam Caudill"),
                Encoding.UTF8.GetBytes("01234567890123456789012345678901"));
        ...
        public void SimpleAuthHmacSha512Test()
        {
            ...
            var actual = SecretKeyAuth.SignHmacSha512(
                Encoding.UTF8.GetBytes("Adam Caudill"),
                Encoding.UTF8.GetBytes("01234567890123456789012345678901"));
        ...
        {
            var actual = SecretKeyAuth.Verify(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            var actual = SecretKeyAuth.VerifyHmacSha256(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            var actual = SecretKeyAuth.VerifyHmacSha512(
                Encoding.UTF8.GetBytes("Adam Caudill"),
