...
namespace Sodium.Tests
{
    ...
    public class StreamEncryptionExceptionTest
    {
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => StreamEncryption.Encrypt(
        ...
        {
            Assert.Throws<NonceOutOfRangeException>(() => StreamEncryption.Encrypt(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => StreamEncryption.Decrypt(
        ...
        {
            Assert.Throws<NonceOutOfRangeException>(() => StreamEncryption.Decrypt(
                Utilities.HexToBinary("c7b7f04c00e14b02dd56c78c"),
                Encoding.UTF8.GetBytes("ABCDEFGHIJKLMNOPQRSTUVW"),
                Encoding.UTF8.GetBytes("12345678901234567890123456789012")));
        }
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => StreamEncryption.EncryptChaCha20(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<NonceOutOfRangeException>(() => StreamEncryption.EncryptChaCha20(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => StreamEncryption.DecryptChaCha20(
        ...
        {
            Assert.Throws<NonceOutOfRangeException>(() => StreamEncryption.DecryptChaCha20(
                Utilities.HexToBinary("a6ce598d8b865fb328581bcd"),
                Encoding.UTF8.GetBytes("ABC"),
                Encoding.UTF8.GetBytes("12345678901234567890123456789012")));
        }
