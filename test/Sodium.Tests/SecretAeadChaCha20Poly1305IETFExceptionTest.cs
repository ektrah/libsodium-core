...
namespace Sodium.Tests
{
    ...
    public class SecretAeadChaCha20Poly1305IETFExceptionTest
    {
        ...
        public void SecretAeadChaCha20Poly1305IETFEncryptWithBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => SecretAeadChaCha20Poly1305IETF.Encrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadChaCha20Poly1305IETFEncryptWithBadNonce()
        {
            ...
            Assert.Throws<NonceOutOfRangeException>(() => SecretAeadChaCha20Poly1305IETF.Encrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadChaCha20Poly1305IETFEncryptWithBadAdditionalData()
        {
            ...
            Assert.Throws<AdditionalDataOutOfRangeException>(() => SecretAeadChaCha20Poly1305IETF.Encrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadChaCha20Poly1305IETFDecryptWithBadKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => SecretAeadChaCha20Poly1305IETF.Decrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadChaCha20Poly1305IETFDecryptWithBadNonce()
        {
            ...
            Assert.Throws<NonceOutOfRangeException>(() => SecretAeadChaCha20Poly1305IETF.Decrypt(m, nonce, key, ad));
        }
        ...
        public void SecretAeadChaCha20Poly1305IETFDecryptWithBadAdditionalData()
        {
            ...
            Assert.Throws<AdditionalDataOutOfRangeException>(() => SecretAeadChaCha20Poly1305IETF.Decrypt(m, nonce, key, ad));
        }
    }
}
