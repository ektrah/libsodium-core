...
namespace Sodium.Tests
{
    ...
    public class PublicKeyBoxExceptionTest
    {
        ...
        public void GenerateKeyPairFromPrivateBadKeyTest()
        {
            ...
            Assert.Throws<SeedOutOfRangeException>(() => PublicKeyBox.GenerateKeyPair(bobSk));
        }
        ...
        public void GenerateKeyPairFromPrivateBadSeedTest()
        {
            ...
            Assert.Throws<SeedOutOfRangeException>(() => PublicKeyBox.GenerateSeededKeyPair(invalidSeed));
        }
        ...
        public void PublicKeyBoxCreateWithBadPrivateKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyBox.Create(
                message,
                nonce,
                bobSk,
                alicePk));
        ...
        public void PublicKeyBoxCreateWithBadNonce()
        {
            ...
            Assert.Throws<NonceOutOfRangeException>(() => PublicKeyBox.Create(
                message,
                nonce,
                bobSk,
                alicePk));
        ...
        public void PublicKeyBoxCreateDetachedWithBadPrivateKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyBox.CreateDetached(
                message,
                nonce,
                bobSk,
                alicePk));
        ...
        {
            Assert.Throws<NonceOutOfRangeException>(() => PublicKeyBox.CreateDetached(
        ...
        public void PublicKeyBoxOpenBadPrivateKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyBox.Open(
        ...
        {
            Assert.Throws<NonceOutOfRangeException>(() => PublicKeyBox.Open(
                Utilities.HexToBinary("aed04284c55860ad0f6379f235cc2cb8c32aba7a811b35cfac94f64d"),
        ...
        public void PublicKeyBoxOpenDetachedBadPrivateKey()
        {
            ...
            Assert.Throws<KeyOutOfRangeException>(() => PublicKeyBox.OpenDetached(
                actual.CipherText,
                actual.Mac,
                Encoding.UTF8.GetBytes("ABCDEFGHIJKLMNOPQRSTUVWX"),
        ...
        public void PublicKeyBoxOpenDetachedBadNonce()
        {
            ...
            Assert.Throws<NonceOutOfRangeException>(() => PublicKeyBox.OpenDetached(
                actual.CipherText,
                actual.Mac,
                Encoding.UTF8.GetBytes("ABCDEFGHIJKLMNOPQRSTUVW"),
                Utilities.HexToBinary("2a5c92fac62514f793c0bfd374f629a138c5702793a32c61dadc593728a15975"),
