...
{
    /// <summary>Tests for the SecretAeadChaCha20Poly1305IEFT class</summary>
    [TestFixture]
    public class SecretAeadChaCha20Poly1305IETFTest
    {
        ...
        public void AeadWithAdditionalDataTest()
        {
            ...
            var encrypted = SecretAeadChaCha20Poly1305IETF.Encrypt(m, nonce, key, ad);
            var decrypted = SecretAeadChaCha20Poly1305IETF.Decrypt(encrypted, nonce, key, ad);
        ...
        public void AeadWithoutAdditionalDataTest()
        {
            ...
            var encrypted = SecretAeadChaCha20Poly1305IETF.Encrypt(m, nonce, key);
            var decrypted = SecretAeadChaCha20Poly1305IETF.Decrypt(encrypted, nonce, key);
