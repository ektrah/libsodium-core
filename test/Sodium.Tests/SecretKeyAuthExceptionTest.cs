...
namespace Sodium.Tests
{
    ...
    public class SecretKeyAuthExceptionTest
    {
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => SecretKeyAuth.Sign(
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => SecretKeyAuth.SignHmacSha256(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => SecretKeyAuth.SignHmacSha512(
                Encoding.UTF8.GetBytes("Adam Caudill"),
                Encoding.UTF8.GetBytes("012345678901234567890123456789")));
        }
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => SecretKeyAuth.Verify(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<SignatureOutOfRangeException>(() => SecretKeyAuth.Verify(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => SecretKeyAuth.VerifyHmacSha256(
                Encoding.UTF8.GetBytes("Adam Caudill"),
                Utilities.HexToBinary("9f44681a662b7cde80c4eb34db5102b62a8b482272e3cceef73a334ec1d321c0"),
                Encoding.UTF8.GetBytes("012345678901234567890123456789")));
        }
        ...
        {
            Assert.Throws<SignatureOutOfRangeException>(() => SecretKeyAuth.VerifyHmacSha256(
                Encoding.UTF8.GetBytes("Adam Caudill"),
                Utilities.HexToBinary("9f44681a662b7cde80c4eb34db5102b62a8b482272e3cceef73a334ec1d321"),
                Encoding.UTF8.GetBytes("01234567890123456789012345678901")));
        }
        ...
        {
            Assert.Throws<KeyOutOfRangeException>(() => SecretKeyAuth.VerifyHmacSha512(
                Encoding.UTF8.GetBytes("Adam Caudill"),
        ...
        {
            Assert.Throws<SignatureOutOfRangeException>(() => SecretKeyAuth.VerifyHmacSha512(
                Encoding.UTF8.GetBytes("Adam Caudill"),
